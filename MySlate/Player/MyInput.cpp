...
void UMyInput::ProcessKeyStates(float DeltaTime)
{
	...
	// update states
	for (TMap<EGameKey,FSimpleKeyState>::TIterator It(KeyStateMap); It; ++It)
	{
...
void UMyInput::DetectTwoPointsActions(bool bCurrentState, bool bPrevState, float DeltaTime, const FVector2D& CurrentPosition1, const FVector2D& CurrentPosition2)
{
